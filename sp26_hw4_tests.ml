...
let student_complex_tests : (string * string * string) list = [
    ...
    (* Hita's tests *)
    ("linked_list.oat", "",       "1 1 2 3 3 4 5 5 6 90");
    ("linked_list.oat", "x",     "9 6 5 5 4 3 3 2 1 10");
    ("linked_list.oat", "x x",   "2 2 4 6 6 8 10 10 12 180");
    ("linked_list.oat", "x x x", "2 4 60");
    ("linked_list.oat", "x x x x", "390");
    ("linked_list.oat", "x x x x x", "0 1 1 2 3 3 4 5 5 6 7 8 90");
    ("linked_list.oat", "x x x x x x", "9 6 5 5 4 3 3 2 1 10");
